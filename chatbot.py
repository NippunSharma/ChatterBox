    ...
    if inputMsg.lower() == "end":
        ...
        if processedMsg[0] == "code":
            ...
            if (ans == "" and greetFlag):
                ...
                print("Do you want me to search in the Facebook groups of previous year and other sites like Quora ?")
                ...
                print(ans)
                randAltAns = choice(list(altans1.keys()), size=2, replace=False)
                if len(altans) != 0:
